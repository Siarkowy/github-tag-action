...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let newVersion;
        if (customTag) {
            commits = yield utils_1.getCommits(latestTag.commit.sha, commit_ref);
            ...
            commits = yield utils_1.getCommits(previousTag.commit.sha, commit_ref);
        ...
        yield github_1.createTag(newTag, createAnnotatedTag, commit_ref);
    });
}
